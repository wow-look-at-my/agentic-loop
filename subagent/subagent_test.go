...
func (p *scriptProvider) Complete(_ context.Context, req agentic.Request, _ *agentic.StreamEvents) (*agentic.Completion, error) {
...
// fakeExec is the parent toolset for subagent tests: declares the tools, runs
// them through Execute, and records every call.
...
func TestSubagentTurnEndReportsUnreportedUsage(t *testing.T) {
	silent := &agentic.Completion{Message: agentic.Message{Role: agentic.RoleAssistant, Content: "report"}, StopReason: agentic.StopEndTurn}
