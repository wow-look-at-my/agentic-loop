...
func TestRenderTranscript(t *testing.T) {
	msgs := []agentic.Message{
		{Role: agentic.RoleSystem, Content: "be helpful"},
		{Role: agentic.RoleUser, Content: "  find X  "},
		{Role: agentic.RoleAssistant, Content: "on it", ToolCalls: []agentic.ToolCall{
			{ID: "c1", Name: "srch", Arguments: ` {"q":"x"} `},
			{ID: "c2", Name: "bare", Arguments: "   "},
		}},
		{Role: agentic.RoleTool, Content: "found at Y"},
...
func TestSelectLastN(t *testing.T) {
	msgs := []agentic.Message{{Content: "1"}, {Content: "2"}, {Content: "3"}}
...
func TestSelectByEndIndices(t *testing.T) {
	msgs := []agentic.Message{{Content: "a"}, {Content: "b"}, {Content: "c"}, {Content: "d"}}
