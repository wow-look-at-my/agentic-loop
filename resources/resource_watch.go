...
// resourceWatcher implements ResourceWatcher over a set of sources.
...
func NewResourceWatcher(cfg ResourceWatchConfig) ResourceWatcher {
...
func (w *resourceWatcher) Poll(ctx context.Context) (ResourcePoll, error) {
	var poll ResourcePoll
