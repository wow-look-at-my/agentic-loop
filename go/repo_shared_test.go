...
// named tool.
func execRepoTool(t *testing.T, reg Tools, name string, args any) ToolResult {
	t.Helper()
...
func newFakeGitHub(t *testing.T, cfg GitHubConfig, respond func(c ghCall) (int, string)) (*fakeGitHub, Tools) {
	t.Helper()
...
func newFakeGitHubFull(t *testing.T, cfg GitHubConfig, respond func(c ghCall) (int, string)) (*fakeGitHub, *GitHub, Tools) {
	t.Helper()
...
// client behind them.
func repoToolset(cfg GitHubConfig) Tools {
