...
//
// The format is the definition; this package is one client of it, and the
// reference one. Everything here is expressible as a document, which is what
...
//
//   - One [Completion] per call, with the usage reports folded into the single
...
//     newest one wins is a policy, and this is where it lives.
