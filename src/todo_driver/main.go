...
type recorder struct {
	snapshots [][]agentic.Todo
}

func (r *recorder) write(_ context.Context, todos []agentic.Todo) error {
...
func main() {
	rec := &recorder{}
	tools := agentic.NewTodoTools(agentic.TodoConfig{Write: rec.write})
	...
	//   cancel #2             -> [#1 done]
	want := []agentic.Todo{{ID: 1, Title: "write it", State: agentic.TodoDone}}
